...
console.log(inventory.map((car) => car.car_year).sort());
...
// Using ES6
let newOldCars = inventory.filter((car) => car.car_year < 2001);
console.log(newOldCars.length)
...
// Using ES6
console.log(JSON.stringify(inventory.filter((car) => car.car_make === "BMW" || car.car_make === "BMW")));
